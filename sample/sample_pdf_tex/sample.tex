...
%
\author[id=au{{ loop.index }},addressref={[object Object],[object Object]}]{%
  \fnms{First Author}\ead[label=e{{ loop.index }}]{first@somewhere.com}}
                                                                          \author[id=au{{ loop.index }},addressref={[object Object]}]{%
  \fnms{Second Author}\ead[label=e{{ loop.index }}]{second@somewhere.com}}
                                      \author[id=au{{ loop.index }},addressref={[object Object]}]{%
  \fnms{Third Author}\ead[label=e{{ loop.index }}]{third@somewhere.com}}
                                      \end{aug}
