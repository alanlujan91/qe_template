...
%% Use \counterwithout from etoolbox.       %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\makeatletter
...
as ... in Title~of~the~first~appendix, Title~of~the~second~appendix, etc.
...
Sample of cross-reference to formula (\ref{path}) in First~subsection~of~Appendix~B.
Note that it is better to refer to First~subsection~of~Appendix~B as opposed to Title~of~the~second~appendix, because it is easier for the reader to locate the necessary place.
